...
DEST_DIR = f"/home/lakes/bonbid-2024/checkpoints/UPPr-{ENCODER}-TLHF-D1"
...
if WANDB_ON:
    wandb.init(project=f"UPP-{ENCODER}-TLHF-D1",
            name = "Run-1",
                config={
            "mode": mode,
...
loss = TverskyLogHausdorffFocalLoss(lambda_focal=4, lambda_hausdorff=2, lambda_tversky=1.5, alpha_tversky=0.3, beta_tversky=0.7, gamma_focal=3)
...
# optimizer.param_groups[0]["lr"] = 0.9*0.1*0.0001
# print("LR:",optimizer.param_groups[0]["lr"])
# %%
train_dataset = HIE_Dataset(
    images_dir = [f'{DATA_ROOT}/BONBID2024_Train/ADC',f'{DATA_ROOT}/BONBID2024_Train/Z_ADC'] if num_channels == 2 else [f'{DATA_ROOT}/BONBID2024_Train/ADC',f'{DATA_ROOT}/BONBID2024_Train/Z_ADC',f'{DATA_ROOT}/BONBID2024_Train/ATLAS'],
...
val_dataset = HIE_Dataset(
    images_dir = [f'{DATA_ROOT}/BONBID2024_Val/ADC',f'{DATA_ROOT}/BONBID2024_Val/Z_ADC'] if num_channels == 2 else [f'{DATA_ROOT}/BONBID2024_Val/ADC',f'{DATA_ROOT}/BONBID2024_Val/Z_ADC',f'{DATA_ROOT}/BONBID2024_Val/ATLAS'],
