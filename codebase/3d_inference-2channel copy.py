...
# make a function to save all image pairs individually
def save_all_slices(gt_masks, pred_masks, uid):
    for i in range(gt_masks.shape[0]):
        ...
        plt.tight_layout()
        plt.savefig(f'/Users/amograo/Desktop/OneSeventy/{uid}_slice_{i}.png')
        plt.close()
...
nsd_l = []
model.eval()
image_paths = [f'{DATA_ROOT}/ADC',f'{DATA_ROOT}/Z_ADC'] #f'{DATA_ROOT}/{TV}/ADC',
